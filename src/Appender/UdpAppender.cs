...
namespace log4net.Appender 
{
	...
	public class UdpAppender : AppenderSkeleton
	{
        ...
        private bool m_serialization = false;
        /// <summary>
        /// 发送格式是否是序列化
        /// </summary>
			...
			try 
			{
                ...
                if (this.Serialization)
                {
                    using (MemoryStream ms = new MemoryStream())
                    {
                        ...
                        formatter.Serialize(ms, loggingEvent);
                ...
                {
                    buffer = m_encoding.GetBytes(RenderLoggingEvent(loggingEvent).ToCharArray());
                }
